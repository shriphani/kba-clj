...
;
    ...
    if (other.isSetSource_metadata()) {
      Map<String,ByteBuffer> __this__source_metadata = new HashMap<String,ByteBuffer>(other.source_metadata.size());
    ...
    if (other.isSetOther_content()) {
      Map<String,ContentItem> __this__other_content = new HashMap<String,ContentItem>(other.other_content.size());
    ...
    if (other.isSetRatings()) {
      Map<String,List<Rating>> __this__ratings = new HashMap<String,List<Rating>>(other.ratings.size());
      for (Map.Entry<String, List<Rating>> other_element : other.ratings.entrySet()) {
        ...
        List<Rating> __this__ratings_copy_value = new ArrayList<Rating>(other_element_value.size());
    ...
    if (other.isSetExternal_ids()) {
      Map<String,Map<String,String>> __this__external_ids = new HashMap<String,Map<String,String>>(other.external_ids.size());
      for (Map.Entry<String, Map<String,String>> other_element : other.external_ids.entrySet()) {
        ...
        Map<String,String> __this__external_ids_copy_value = new HashMap<String,String>(other_element_value.size());
