 ...
 */
public class StreamTime implements org.apache.thrift.TBase<StreamTime, StreamTime._Fields>, java.io.Serializable, Cloneable, Comparable<StreamTime> {
  ...
  public int compareTo(StreamTime other) {
    ...
    lastComparison = Boolean.valueOf(isSetEpoch_ticks()).compareTo(other.isSetEpoch_ticks());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEpoch_ticks()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.epoch_ticks, other.epoch_ticks);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetZulu_timestamp()).compareTo(other.isSetZulu_timestamp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetZulu_timestamp()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.zulu_timestamp, other.zulu_timestamp);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
